...
import com.googlecode.arit.rmi.RmiExportScannerPlugin;

public class HarmonyRmiExportScannerPlugin implements RmiExportScannerPlugin {
    private final Collection<WeakReference<?>> refs;
    
    public HarmonyRmiExportScannerPlugin() {
