...
@Target("sun.rmi.transport.ObjectTable")
public interface ObjectTableRBean extends StaticRBean {
    @Accessor(name="implTable")
    Map<WeakReference<?>,?> getImplementationTable();
}
